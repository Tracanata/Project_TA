...
<div class="card">
    <div class="card-body">
        ...
        <div class="col-lg-8">
            <<<<<<< HEAD <form method="post" action="/dashboard/mahasiswas/edit/{{$mahasiswa->id}}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="mb-3">
                    <label for="npm" class="form-label">NPM</label>
                    <input type="number" class="form-control @error('npm') is-invalid @enderror" id="npm" name="npm" value="{{ old('npm', $mahasiswa->npm) }}">
                    @error('npm')
                ...
                <form method="POST" action="/dashboard/mahasiswas/{{$mahasiswa->id}}" enctype="multipart/form-data">
                    ...
                    <<<<<<< HEAD @enderror </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('angkatan') is-invalid @enderror" id="angkatan" name="angkatan" value="{{ old('angkatan', $mahasiswa->angkatan) }}">
                            @error('angkatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('no_ijazah') is-invalid @enderror" id="no_ijazah" name="no_ijazah" value="{{ old('no_ijazah', $mahasiswa->no_ijazah) }}">
                            @error('no_ijazah')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
